...
/**
 * @author Arell Clase genérica ColaDePrioridad<T>
 *
...
public class ColaDePrioridad<T> {
    ...
    private final List<ObserverSalida> observersSalida = new ArrayList<>();
    private final List<ObserverEntrada> observersEntrada = new ArrayList<>();

    /**
     * Registra un nuevo observadorSalida (por ejemplo, el Sender).
     */
    public void addObserverSalida(ObserverSalida o) {
     ...
     */
    public void removeObserverSalida(ObserverSalida o) {
    ...
    public void notificarColaSalida() {
        for (ObserverSalida o : observersSalida) {
            o.updateSalida();
        }
    }
     ...
     */
    public void addObserverEntrada(ObserverEntrada o) {
     ...
     */
    public void removeObserverEntrada(ObserverEntrada o) {
    ...
    public void notificarColaEntrada() {
        for (ObserverEntrada o : observersEntrada) {
            o.updateEntrada();
        }
    }
     ...
     */
    public void add(T elemento, TipoAdd tipo) throws InterruptedException {
        if (elemento == null) {
