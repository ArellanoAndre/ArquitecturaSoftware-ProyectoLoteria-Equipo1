 ...
 * disponible.
 */
public class Sender implements ObserverEntrada {
     ...
     */
    public Sender(IDispatcher dispatcher, ColaDePrioridad<String> colaEntrada) {
     ...
     *
     * La cola NO entrega el JSON directamente, por lo que el Sender debe
