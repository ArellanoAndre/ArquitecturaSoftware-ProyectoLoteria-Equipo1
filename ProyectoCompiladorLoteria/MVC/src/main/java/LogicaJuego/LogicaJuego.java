 ...
 */
public class LogicaJuego implements ILogicaJuego {
    ...
    private ILogicaJuego modeloJuegoSecundario;
     ...
     */
    public LogicaJuego(IControlVista controlVista, Jugador jugador, List<Jugador> jugadores) {
     ...
     */
    @Override
    public ILogicaJuego getModeloJuegoSecundario() {
     ...
     */
    @Override
    public void setModeloJuegoSecundario(ILogicaJuego modeloJuegoSecundario) {
